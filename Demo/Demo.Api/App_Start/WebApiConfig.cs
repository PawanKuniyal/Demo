...
namespace Helpa.Api
{
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            //var jsonFormattor = config.Formatters.OfType<JsonMediaTypeFormatter>().First();
            //jsonFormattor.SerializerSettings.ContractResolver = new CamelCasePropertyNamesContractResolver();
